...
\begin{itemize}
 ...
 \item Overview of methods using some sort of mesh intersections.
 \item Our motivation from groundwater applications.
 \item Existing algorithms.
 \item Our contribution:
    new algorithms for element intersections based on \plucker coordinates,
...
We consider a composed mesh $\mathcal T$ consisting of meshes $\mathcal T_i$ of dimensions $d_i \in \{1,2,3\}$, $i=1,\dots,N_\mathcal{T}$. 
...
for the line-tetrahedron intersections. These are used as the building block for the triangle-triangle and the trinagle-tetrahedron cases.
