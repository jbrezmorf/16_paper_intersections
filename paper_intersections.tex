...
Algorithm \ref{algo:colect_23_ip_triangle} pass through every side $s$ of the triangle $S_3$ computing the line-tetrahedron intersection $L$.
...
This condition is effective just for the first IP in $L$ and merge IPs at the same vertex of $S_3$. Then we identify an object $x\in M_4$ the point
...
For the intersection $L$ we pass through its IPs. 
