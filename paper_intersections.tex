...
\begin{minipage}{\textwidth}
  ...
  \begin{minipage}[b]{0.5\textwidth}
    ...
    \captionof{figure}{Efficiency of \plucker approach compared to the legacy NGH code.}
    \label{fig:fundamental_speed}
    \end{minipage}
\end{minipage}
\vspace{2ex}

We see the benchmark results in the \fig{fig:fundamental_speed}. Green values correspond the presented algorithms
using \plucker coordinates, red values \notePE{***}NGH. The gained speed up factor is approximately 5 in 1D-3D case and 2 in 2D-3D. Further we provide estimated count of floating point operations for different approaches in the Table \ref{tab:fundamental_flops}.
