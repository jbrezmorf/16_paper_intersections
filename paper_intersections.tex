...
Correspondingly the candidate paris are enqueued into \emph{component queue} $Q_c$ and the \emph{bulk queue} $Q_b$, respectively.
...
In some of the empty cases, the bounding boxes did not collide, so the actual intersection algorithms were skipped. 
A single element pair was computed 100 times to obtain reasonable computational time.
