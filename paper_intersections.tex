...
\notePE{I would stick to chosen notation - triangle $S_3$, and possibly renamed side $s_i$...}
...
$S_4$. The used algorithm is based on the 1d-2d algorithm and closely follows \cite{platis_fast_2003}. Our modification takes into account
...
\begin{algorithm}
  ...
  \SetKw{break}{break}
  \KwIn{Tetrahedron $S_4$, line segment $p$.}
  \KwOut{List $I$ of ICs sorted along $p$.}  
  $I=\{\}$\; 
  \For{unmarked face $f$ of $S_4$}{
...
\end{algorithm}
Algorithm \ref{algo:13d} first computes line-face intersections for every face of $S_4$.
